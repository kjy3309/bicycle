...
<body>
    ...
    <div id="out">
		...
		<form action="Adwrite" method="post">
            <table>
				<tr>
					<th>받는이</th>
					<td><input type="text" name="user_name" style="color: white; background-color: rgb(44, 43, 43); border: 1px rgb(14, 13, 13); width: 400px; height: 20px;"/></td>
				</tr>
                <tr>
                    <th>제목</th>
